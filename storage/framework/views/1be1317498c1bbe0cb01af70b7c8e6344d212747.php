...
<body>
  ...
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap  p-0    shadow">
     <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo e(url('/')); ?>"><i class="fas fa-tachometer-alt"></i>&nbsp;&nbsp;Admin</a>
  ...
  <div class="container-fluid has-background-white">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse ">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('hoteladmin')); ?>">
      ...
      <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 has-background-white">
        <div id="app">
          <?php echo $__env->yieldContent('hotels'); ?>
        </div>
...
<?php /**PATH /home/ziita/Documents/New/LastOne/resources/views/PanelAdmin/panel.blade.php ENDPATH**/ ?>