       ...
       <b-menu>
         <b-menu-list label="Menu">
           ...
           <b-menu-item icon="users" icon-pack="fas" >
             ...
             <b-menu-item icon="address-card" icon-pack="far" label="Clients Data"  class="noDeco" href="<?php echo e(url('us')); ?>" ></b-menu-item>
...
<?php /**PATH /home/ziita/Documents/New/LastOne/resources/views/PanelAdmin/sidebar.blade.php ENDPATH**/ ?>